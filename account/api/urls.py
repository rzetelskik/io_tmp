...
from .views import register, login, CustomUserDetailView, password_update, details_update, CustomUserLocationView, ListMatchingUsersView
...
urlpatterns = [
    ...
    path('user-location/', CustomUserLocationView.as_view(), name='custom-user-location'),
